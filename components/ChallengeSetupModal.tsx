...
export const ChallengeSetupModal: React.FC<Props> = ({ profiles, onStart, onCreate, onDelete }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#09090b]">
      ...
      <div className="relative glass-bubble border border-white/10 rounded-3xl shadow-2xl w-[800px] min-h-[600px] flex flex-col max-h-[90vh] overflow-hidden font-sans text-slate-200 ring-1 ring-white/5 animate-in zoom-in-95 duration-300">
            ...
            {view === 'CREATE' && (
                <div className="max-w-md mx-auto space-y-6">
                    ...
                    <div className="space-y-2 relative" ref={dropdownRef}>
                        ...
                        {isAssetDropdownOpen && (
                            <div className="absolute top-full left-0 w-full mt-2 glass-panel border border-white/10 rounded-xl shadow-2xl z-50 max-h-60 overflow-y-auto custom-scrollbar p-1">
